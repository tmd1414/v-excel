  ...
  <div class="rightmouse-panel-div" ref="contexmenu_excel" @mouseleave="closeRightPanel">
    <div class="panel-div-left">
      ...
      <!-- <div class='wb fuzhidanyuange'>
        ...
        <div class='hr'></div> -->
      <div class="wb addup">
        <div class="excel-rightmomuse-icon-css">
          <div class="ve-icon">
            <div class="ve-icon-self angle-up"></div>
          </div>
        </div>
        <span class="excel-rightmomuse-text-css" @click="addRowCol('addbefore')">上方插入一行</span>
      </div>
      <div class="wb adddown">
        <div class="excel-rightmomuse-icon-css">
          <div class="ve-icon">
            <div class="ve-icon-self angle-down"></div>
          </div>
        </div>
        <span class="excel-rightmomuse-text-css" @click="addRowCol('addafter')">下方插入一行</span>
      </div>

      <!--测试-->
      <div class="wb addleft">
        <div class="excel-rightmomuse-icon-css">
          <div class="ve-icon">
            <div class="ve-icon-self angle-left"></div>
          </div>
        </div>
        <span class="excel-rightmomuse-text-css" @click="addRowCol('addleft')">左边插入一列</span>
      </div>
      <div class="wb addright">
        <div class="excel-rightmomuse-icon-css">
          <div class="ve-icon">
            <div class="ve-icon-self angle-right"></div>
          </div>
        </div>
        <span class="excel-rightmomuse-text-css" @click="addRowCol('addright')">右边插入一列</span>
      </div>

      <div class="hr"></div>

      <div class="wb del-row">
        <div class="excel-rightmomuse-icon-css">
          <div class="ve-icon">
            <div class="ve-icon-self row-del"></div>
          </div>
        </div>
        <span class="excel-rightmomuse-text-css" @click="addRowCol('delrow')">删除行</span>
      </div>
      <div class="wb del-col">
        <div class="excel-rightmomuse-icon-css">
          <div class="ve-icon">
            <div class="ve-icon-self col-del"></div>
          </div>
        </div>
        <span class="excel-rightmomuse-text-css" @click="addRowCol('delcol')">删除列</span>
      </div>
...
<!--      <div class="wb shanchuhang">
      ...
      <div class="wb shanchulie">
        ...
        </div><span class="excel-rightmomuse-text-css" @click="addRowCol('delcol')">删除列</span>
      </div> -->
